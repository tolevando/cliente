...
Future<Stream<Product>> searchProductsOfMarket(
    String search, Address address, Market market) async {
  Uri uri = Helper.getUri('api/products');
  Map<String, dynamic> _queryParams = {};
  _queryParams['search'] = 'name:$search;description:$search';
  _queryParams['searchFields'] = 'name:like;description:like;description:like';
  _queryParams['limit'] = '5';

  _queryParams['market_id'] = market.id.toString();
