...
class Setting {
  ...
  Setting.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      pagarmeEnabled = jsonMap['enable_pagarme'] == null || jsonMap['enable_pagarme'] == '0' ? false : true;
      ...
      facebookEnabled = jsonMap['enable_facebok'] == null || jsonMap['enable_facebok'] == '0' ? false : true;
      cidades = List<Cidade>.from(jsonMap['cidades'].map((cidade) => Cidade.fromJSON(cidade)));
      
      //for (int _i = 0; _i <= jsonMap['cidades'].size(); _i++) {
        //Cidade c = Cidade.fromJSON(jsonMap['cidades'][0]);
      //}
      /*Map<String,dynamic> parsed = json.decode(jsonMap['cidades']);
      print(parsed);*/
      print(cidades);
    } catch (e) {
      //print(cidades);
  ...
  Map toMap() {
    ...
    map["enable_pagarme"] = pagarmeEnabled;
    map["enable_razorpay"] = razorPayEnabled;
    map["enable_facebook"] = facebookEnabled;
