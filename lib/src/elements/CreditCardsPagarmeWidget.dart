...
import 'package:markets/src/elements/PaymentSettingsPagarmeDialog.dart';
...
class CreditCardsPagarmeWidget extends StatelessWidget {
  CreditCardPagarme creditCard;
  ValueChanged<CreditCardPagarme> onChanged; 

  CreditCardsPagarmeWidget({
    this.creditCard,
    this.onChanged,
    Key key,
  }) : super(key: key);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    ...
                    ButtonTheme(
                      ...
                      minWidth: 50.0,
                      height: 10.0,
                      child: PaymentSettingsPagarmeDialog(
                ...
                Text(
                  Helper.getCreditCardNumberHidden(creditCard.number),
