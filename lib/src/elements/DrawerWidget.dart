        ...
        children: <Widget>[
            ...
            child: currentUser.value.apiToken != null
                ? UserAccountsDrawerHeader(
                    ...
                    currentAccountPicture: CircleAvatar(
                      ...
                      backgroundImage: AssetImage('assets/img/logo_dashboard_app.png'),
                    ),
                  )
                : Container(
          ...
          ListTile(
            ...
            title: Text(
              ...
              ListTile(
                onTap: () {
                  Navigator.of(context).pushNamed('/Cidadela2');
                },
                leading: Icon(
                  Icons.location_city,
                  color: Theme.of(context).focusColor.withOpacity(1),
              ...
              ListTile(
              onTap: () {
                Helper.launchURL('Solicitar Estabelecimento', 'Descrição do Estabelecimento');
              },
              leading: Icon(
                Icons.mail,
                color: Theme.of(context).focusColor.withOpacity(1),
