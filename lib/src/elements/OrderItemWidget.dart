                  ...
                  child: ExpansionTile(
                    ...
                    title: Column(
                      children: <Widget>[
                        ...
                        Text(
                          'Delivery: ${widget.order.productOrders.first.product.market?.estimated_time_delivery ?? '-'}',
                          style: Theme.of(context).textTheme.caption,
                        ),
                        Text(
                          'Retirada: ${widget.order.productOrders.first.product.market?.estimated_time_get_product ?? '-'}',
                          style: Theme.of(context).textTheme.caption,
                        ),
                      ],
                    ...
                    trailing: Column(
                      ...
                      children: <Widget>[
                        Helper.getPrice(
                            /*Helper.getTotalOrdersPrice(widget.order)*/ widget
                                .order.payment.price,
                            context,
                              ...
                              children: <Widget>[
                                ...
                                Helper.getPrice(
                                    widget.order.payment
                                        .price /*Helper.getTotalOrdersPrice(widget.order),*/,
                                    context,
                                    style:
