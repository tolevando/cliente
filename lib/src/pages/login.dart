                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 10),
                      setting.value.facebookEnabled?
                      SignInButton(Buttons.FacebookNew, text: "Entrar com o Facebook",
                        onPressed: (){
                          Navigator.of(context).pushReplacementNamed('/FacebookLogin');
                        }
                      ):SizedBox(height: 10),
                    ],
                  ),
