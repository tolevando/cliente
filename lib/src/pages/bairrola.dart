...
class BairrolaWidget extends StatefulWidget {
  final RouteArgument routeArgument;
  @override
  _BairrolaWidgetState createState() => _BairrolaWidgetState();

  BairrolaWidget({Key key, this.routeArgument}) : super(key: key);
}

class _BairrolaWidgetState extends StateMVC<BairrolaWidget> {
  SettingsController _con;
  
  _BairrolaWidgetState() : super(SettingsController()) {
    _con = controller;
