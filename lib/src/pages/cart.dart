...
class _CartWidgetState extends StateMVC<CartWidget> {
  ...
  void initializeDateHour() async {
    ...
    sharedPreferences.setString("data_hora",
        "${_con.pickedDate.day}/${_con.pickedDate.month}/${_con.pickedDate.year} ${_con.time.hour}:${_con.time.minute}");
  }
                                ...
                                return InkWell(
                                  onTap: () async {
                                    ...
                                    await prefs.setString(
                                        'last_market_bairro_selecionado',
                                        _con.carts
                                            .elementAt(0)
                                            .product
                                            .market
                                            .id);
                                    await prefs.setString(
                                        'last_market_bairro_id', _bairro.id);
                                    await prefs.setString(
                                        'last_market_bairro_name',
                                        _bairro.nome);
                                    await prefs.setDouble(
                                        'last_market_bairro_fee',
                                        double.parse(_bairro.valor));
                                    setState(() =>
                                        _con.precisaSelecionarBairro = false);
                                    setState(() => _con.deliveryFee =
                                        double.parse(_bairro.valor));
                                    setState(() => _con.carts[0].product.market
                                            .deliveryFee =
                                        double.parse(_bairro.valor));
                                  ...
                                  : Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          ListTile(
                                            title: Text(
                                                "Data: ${_con.pickedDate.day}/${_con.pickedDate.month}/${_con.pickedDate.year}"),
                                            trailing:
                                          ...
                                          ListTile(
                                            title: Text(
                                                "Hora: ${_con.time.hour}:${_con.time.minute}"),
                                            trailing:
                                                Icon(Icons.keyboard_arrow_down),
                                            onTap: _pickTime,
                                          ),
  ...
  _pickTime() async {
    TimeOfDay t =
        await showTimePicker(context: context, initialTime: _con.time);
    if (t != null)
      setState(() {
        _con.time = t;
      });
