...
class PagarmeCartaoRecusadoWidget extends StatefulWidget {
//  RouteArgument routeArgument;
//  PagarmeCartaoRecusadoWidget({Key key, this.routeArgument}) : super(key: key);
  @override
  _PagarmeCartaoRecusadoWidgetState createState() => _PagarmeCartaoRecusadoWidgetState();
}

class _PagarmeCartaoRecusadoWidgetState extends StateMVC<PagarmeCartaoRecusadoWidget> {
  CheckoutController _con;

  _PagarmeCartaoRecusadoWidgetState() : super(CheckoutController()) {
    _con = controller;
  }
                            ...
                            child: FlatButton(
                              onPressed: () {
                                if (_con.creditCardPagarme.validated()) {
                                  Navigator.of(context).pushNamed('/OrderSuccess', arguments: new RouteArgument(param: 'Credit Card (Pagarme Gateway)'));
                                } else {
