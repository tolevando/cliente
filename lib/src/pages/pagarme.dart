...
class PagarmeWidget extends StatefulWidget {
//  RouteArgument routeArgument;
//  PagarmeWidget({Key key, this.routeArgument}) : super(key: key);
  @override
  _PagarmeWidgetState createState() => _PagarmeWidgetState();
}

class _PagarmeWidgetState extends StateMVC<PagarmeWidget> {
  CheckoutController _con;

  _PagarmeWidgetState() : super(CheckoutController()) {
    _con = controller;
  }
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Helper.getPrice(_con.getTotal(), context, style: Theme.of(context).textTheme.headline6)
                            ],
                          ),
                          SizedBox(height: 20),
                          SizedBox(
