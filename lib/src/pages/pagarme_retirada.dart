...
class PagarmeRetiradaWidget extends StatefulWidget {
//  RouteArgument routeArgument;
//  PagarmeRetiradaWidget({Key key, this.routeArgument}) : super(key: key);
  @override
  _PagarmeRetiradaWidgetState createState() => _PagarmeRetiradaWidgetState();
}

class _PagarmeRetiradaWidgetState extends StateMVC<PagarmeRetiradaWidget> {
  CheckoutController _con;

  _PagarmeRetiradaWidgetState() : super(CheckoutController()) {
    _con = controller;
  }
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Helper.getPrice(_con.getTotal(met:"Pagar na Retirada"), context, style: Theme.of(context).textTheme.headline6)
                            ],
                          ),
                          SizedBox(height: 20),
                          SizedBox(
